...
module.exports = {
  ...
  permissions: ["SEND_MESSAGES", "READ_MESSAGES", "BAN_MEMBERS"], // Command Permissions
  memberPermissions: ["SEND_MESSAGES", "READ_MESSAGES", "BAN_MEMBERS"], // User is required to have these permissions
